CREATE INDEX IF NOT EXISTS idx_sli_conn_created_legacy
  ON public.sales_line_items (connection_id, created_at DESC)
  INCLUDE (provider_product_id, name, family, format, winerim_product_id, quantity);

CREATE OR REPLACE FUNCTION public.review_legacy_products(
