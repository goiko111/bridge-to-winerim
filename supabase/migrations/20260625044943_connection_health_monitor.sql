...
-- This is intentionally observational: it does not retry queues, change stock, or
-- mutate POS data. It records health checks and opens/resolves incidents.
...
-- Helper used by pg_cron/pg_net once the deployed function URL and service key
-- are available in the Lovable Cloud SQL console.
