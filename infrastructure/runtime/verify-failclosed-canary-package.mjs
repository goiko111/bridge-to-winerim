...
function main() {
  ...
  requireText(consumer, 'CANARY_RUNTIME_JOB = "{{CANARY_RUNTIME_JOB}}"', "CANARY_RUNTIME_JOB_NOT_BOUND");
  requireText(consumer, 'CANARY_RUNTIME_LANE = "{{CANARY_RUNTIME_LANE}}"', "CANARY_RUNTIME_LANE_NOT_BOUND");
  ...
  requireText(executor, 'RUNTIME_AGORA_CREDENTIAL_MODE = "{{RUNTIME_AGORA_CREDENTIAL_MODE}}"', "CANARY_AGORA_MODE_NOT_TEMPLATED");
  requireText(executor, 'RUNTIME_SALES_EXECUTION_ENABLED = "false"', "CANARY_EXECUTOR_BROAD_SALES_FORBIDDEN");
  requireText(executor, 'RUNTIME_CATALOG_EXECUTION_ENABLED = "{{RUNTIME_CATALOG_EXECUTION_ENABLED}}"', "CANARY_CATALOG_EXECUTION_NOT_TEMPLATED");
  requireText(executor, 'RUNTIME_CATALOG_APPLY_ENABLED = "{{RUNTIME_CATALOG_APPLY_ENABLED}}"', "CANARY_CATALOG_APPLY_NOT_TEMPLATED");
  ...
  requireText(executor, 'CANARY_RUNTIME_JOB = "{{CANARY_RUNTIME_JOB}}"', "CANARY_EXECUTOR_JOB_NOT_BOUND");
  requireText(executor, 'CANARY_RUNTIME_LANE = "{{CANARY_RUNTIME_LANE}}"', "CANARY_EXECUTOR_LANE_NOT_BOUND");
  requireText(executor, 'CANARY_CATALOG_PRODUCT_ID = "{{CANARY_CATALOG_PRODUCT_ID}}"', "CANARY_CATALOG_PRODUCT_NOT_BOUND");
