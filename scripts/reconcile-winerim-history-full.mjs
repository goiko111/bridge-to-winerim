...
const md = [
  ...
  `|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|`,
  ...summary.map((r) => `| ${r.restaurante} | ${r.lineas_agora} | ${r.total_clasificado} | ${r.historial_winerim} | ${r.operaciones} | ${r.legado} | ${r.COINCIDENTE_CLAVE} | ${r.COINCIDENTE_LEGADO} | ${r.CANDIDATA_SIN_CLAVE} | ${r.AMBIGUA} | ${r.FALTANTE_COMPROBADA} | ${r.POSIBLE_DUPLICADA} | ${r.FUERA_DE_AGORA} | ${r.stock_pendiente} |`),
  ``,
